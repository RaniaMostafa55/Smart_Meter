...
class EditPasswordUI extends StatefulWidget {
  @override
  _EditPasswordUIState createState() => _EditPasswordUIState();
}
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildTextField('ent new pass'.tr, true, npass),
              buildTextField('rent pass'.tr, true, nnpass),
              SizedBox(height: 20),
              Row(
